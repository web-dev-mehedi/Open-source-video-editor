...
import { formatAssTimestamp, formatSrtTimestamp } from './timecode';
...
/**
 * Generate full ASS subtitle script for FFmpeg libass burning
 */
...
`;
  ...
  const events = captions.map((line) => {
    ...
    // 5. Active Word Highlighting (MrBeast, Hormozi, Bold Pop, Punch, 3D, Bounce, etc.)
